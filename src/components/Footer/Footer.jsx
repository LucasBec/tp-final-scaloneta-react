    ...
    <footer className="footer-container">
      <Container fluid className="d-flex flex-column align-items-center">
        <ul className="nav social-icons">
          <li>
            <a href="https://twitter.com/AFA" className="text-body-secondary" target="_blank">
          ...
          <li>
            <a href="https://www.instagram.com/afa.oficial/" className="text-body-secondary" target="_blank">
          ...
          <li>
            <a href="https://www.facebook.com/AFAOFICIAL/" className="text-body-secondary" target="_blank">
